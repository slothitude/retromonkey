...
- [ ] **Fulfill first eBay order — Anbernic RG35XX H (DROP SHIP)**
  ...
  - Action: Go to Alibaba, find RG35XX H supplier, order 5 units (1 for buyer + 4 stock), ship buyer's unit direct to his address
  - Cost basis: $77/unit in DB — verify with actual supplier pricing
  - Blocker: All automated search tools down — Aaron must search manually
